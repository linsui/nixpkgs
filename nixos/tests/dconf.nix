import ./make-test-python.nix
  ({ lib, ... }:
  {
    ...
    testScript = ''
      ...
      machine.succeed("test $(dconf read -d /test/slash/format) == 'true'")
      ...
      machine.fail("sudo -u alice dbus-run-session -- dconf write /test/slash/format \"@b true\"")
    '';
  })
