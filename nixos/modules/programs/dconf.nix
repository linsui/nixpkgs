...
let
  ...
  mkDconfDb = val: compileDconfDb (pkgs.symlinkJoin {
    ...
    paths = [
      ...
      (pkgs.writeTextDir "locks/nixos-generated-dconf-locks" (lib.generators.toDconfLocks
        (lib.recursiveUpdate (recursiveLock val.settings val.lockSubpaths) val.locks)))
